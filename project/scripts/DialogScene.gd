...
var events := {
	...
	S.events.REWARDS: ["You built the bar, but no one's coming! Spending you days chatting with the few who pass by, you hear tales of slime attacks in the fields on the way into town. Travelers have started to avoid this dangerous route. 'What about the adventuers, don't they usually love killing monsters and such?' you ask. 'Well', they tell you, 'slimes don't drop loot'", "The guild discusses the problem. Being the local inn keepers, maybe you should be offering quests! Where else do adventurers look for work. You offer a reward - one coin for one slime vanquished. Enough for an ale.\n\nUnlocked:\nDaily Happenings: Slimes brought in", "Almost immediately, an adventurer enters and drops a giant globule mass on the bar. 'I'm here for the slime bounty! Slimes don't have tails.... or anything to cut off... so I brought the whole thing, haha!' They laugh, accepting the coin."],
	S.events.POTIONS: ["It's working! More patrons are coming in now that it's safer. But now you have so many slimes now. They fill the store houses, guild members leave them strewn in their backyards exposed to the elements. They are annoyingly shelf stable.","Once again your chatty patrons have the answer. An old apothicarist with stringy grey hair and bony fingers comes through and you tell her your troubles (she's seen them sitting around town). 'An expert alchemist such as myself can solve your problem' she says confidently 'You may have noticed they last a long time, but that isn't their only amazing talent. They'll preserve you too! When a slime is carfully reduced to a small vial of liquid, one may drink a slime and feel their wounds close and bruises shrink. It doesn't last forever, just long enough to make it to the nearest place to rest", "Before you can say 'I've got to talk to the others', she's commandeered a table in the bar and set up her bag of supplies in the back. I guess your innkeepers guild, " + guild_name + ", has a resident apothicary now!", "The young adventurers coming in have been looking pretty defeated by these slimes, you're sure they'll buy your potions back, one potion for one coin.\n\nUnlocked:\nStock: Potions\nActions: Make Potions\nDaily Happenings: Potions sold"]
}
